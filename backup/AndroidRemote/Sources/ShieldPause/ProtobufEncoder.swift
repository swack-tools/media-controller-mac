...
struct ProtobufEncoder {
    ...
    private static func encodeVarint(_ value: UInt32) -> [UInt8] {
        var result: [UInt8] = []
        var val = value
...
struct AndroidTVMessages {
    ...
    static func createPairingRequest(clientName: String, serviceName: String) -> Data {
        ...
        if !serviceName.isEmpty {
            ...
            // Manually encode length varint (for small strings < 128, it's just the length)
            innerMessage.append(UInt8(serviceName.utf8.count))
        ...
        if !clientName.isEmpty {
            ...
            // Manually encode length varint
            innerMessage.append(UInt8(clientName.utf8.count))
        ...
        // Manually encode length varint
        message.append(UInt8(innerMessage.count))
    ...
    static func createOptionsRequest() -> Data {
        ...
        optionMessage.append(UInt8(encodingData.count))  // Length of encoding object
        ...
        message.append(UInt8(optionMessage.count))
    ...
    static func createConfigurationRequest(encodingType: UInt8 = 0) -> Data {
        ...
        configMessage.append(UInt8(encodingData.count))  // Length of encoding object (4 bytes)
        ...
        message.append(UInt8(configMessage.count))
    ...
    static func createSecretMessage(secret: [UInt8]) -> Data {
        ...
        message.append(UInt8(secretPayload.count))
